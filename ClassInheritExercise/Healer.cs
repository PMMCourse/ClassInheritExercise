...
namespace ClassInheritExercise
{
    class Healer : ICampesino
    {
        ...
        public Healer(string nombre, int vida,int mana, int aguante, int nivel, int XP, int dinero)
        {
            this.Nombre = nombre;
            this.Vida = vida;
            this.mana = mana;
        ...
        //Metodos propios del Healer
        public void UsarHabilidad() { }
        public void CurarAliado() { }
